...
- (FACOLTATIVO) Aggiungere nella cartella 'launch' di rplidar_ros, il file recorded.launch presente nella cartella 'ros' di drone_vineyard e il file exp_cfg.rviz nella cartella 'rviz' di rplidar_ros.
...
- NB. L'utilizzo del file di launch recorded.launch è del tutto facoltativo e i dati possono essere visualizzati anche senza questo file. Esso rimane di supporto per garantire un display immediato dei dati senza dover settare manualmente le configurazioni di rviz.
- 
